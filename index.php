                      ...
                      <div class="mr-4">
                        <?php
                            ...
                            if (isset($login_session)){
                                echo "<a href='opcoes_usu.php'><img id='icone_usu' class='h5 mt-3' style='widht: 40px; height: 40px;' src='imagens/usu.png'></a>";
                            } else {
                                if (isset($login_adm_session)) {
                                    echo "<a href='opcoes_adm.php'><img id='icone_usu' class='h5 mt-3' style='widht: 45px; height: 45px;' src='imagens/adm.png'></a>";
                                } else {
                                    echo '<a class="btn btn-secondary p-1 mt-1 mr-2" href="cadastrar.php">Cadastro</a>
                                    <a class="btn btn-secondary mt-1 p-1" href="logar.php">Login</a>';
                                }
                            }
                        ?>
                       </div>
                        <input class="form-control mt-1 mr-2 col-3 col-md-4"  id="consulta" name="consulta" type="text" placeholder="Buscar...">
                        <button class="btn btn-light mt-1 mr-3" type="submit">Ok</button>
                  </form>
                </div>
            </nav>     
      </nav>
                    ...
                    <div class="collapse navbar-collapse" id="navbarsite">            
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown mr-4">
                                <a class="nav-link dropdown-toggle ml-4" href="#" data-toggle="dropdown" id="navDrop">Notícias</a>
                            ...
                            <li class="nav-item dropdown mx-4">
                                <input type="submit" name="submit" class="nav-link bg-primary border-0" id="navDrop" value="Oficinas">                 
                            </li>
                            <li class="nav-item dropdown mx-4">
